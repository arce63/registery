...
message.channel.send(new MessageEmbed().setDescription(`${member} Adlı kullanıcı ${message.author} tarafından kayıtsıza atıldı! | <@&843575748655579154>`).setFooter("Arcenio 💖 Alves")).then(msg => msg.delete({timeout: 4000}))
