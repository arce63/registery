...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["843575748710629393"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
    return message.reply("Bu komutu kullanmak için \`<@&843575748710629393>\` yetkisine sahip olmalısın")
...
exports.conf = {
    enabled: true,
    guildOnly: true,
    aliases: ["kayıtlarım", "kayıtlar", "kayıt-kontrol", "kstat", "stat", "sorgu"],
    permLvl: 0,
}
